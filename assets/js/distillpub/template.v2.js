...
`, false);
  ...
  function bylineTemplate(frontMatter) {
    return `
  <div class="byline grid" style="display: flex; flex-direction: column; align-items: flex-start;">
